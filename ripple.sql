...
CREATE TABLE IF NOT EXISTS `beatmaps` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=20593 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `clans` (
  ...
  `mlimit` int(128) NOT NULL DEFAULT '10',
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `discord_roles` (
  ...
  `discordid` varchar(25) COLLATE latin1_bin NOT NULL DEFAULT '0',
  `roleid` varchar(25) COLLATE latin1_bin NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `scores` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9328 DEFAULT CHARSET=latin1;
